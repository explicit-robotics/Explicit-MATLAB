...
classdef Arbotix < Machine
    ...
    properties (Constant)
        ...
        ADDR_COMPLIANCE_MARGIN_CW_ = 26;
        ADDR_COMPLIANCE_MARGIN_CCW_ = 27;
        ADDR_COMPLIANCE_SLOPE_CW_ = 28;
        ADDR_COMPLIANCE_SLOPE_CCW_ = 29;
    ...
    methods
        ...
        function connect(arb, opt)
            ...
            arb.serPort = serial(arb.serPort, ...
                'Terminator', '', 'FlowControl', 'none', ...
                'BaudRate', opt.baud, 'DataBits', 8, 'Parity', 'none', 'StopBits', 1);
        ...
        function setpath(arb, jt, t)
            ...
            arb.command(arb.ID_ARBOTIX, Arbotix.INS_ARB_SIZE_POSE, uint8(numcols(jt)));
            ...
            for i=1:numrows(jt)
                pose = jt(i,:);
                arb.command(arb.ID_ARBOTIX, Arbotix.INS_ARB_LOAD_POSE, [i-1 typecast( uint16(pose), 'uint8')]);
            end
            ...
            arb.command(arb.ID_ARBOTIX, Arbotix.INS_ARB_LOAD_SEQ, cmd);

            
            % now do it
            arb.command(arb.ID_ARBOTIX, Arbotix.INS_ARB_PLAY_SEQ);
