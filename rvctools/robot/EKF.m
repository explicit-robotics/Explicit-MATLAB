    ...
    methods
        ...
        %   cleared.
            ...
            for k=1:n
                ...
                % HACK
%                 if k > 1 && opt.ellipse
%                     plot_ellipse(ekf.P_est(1:2,1:2) * chi2inv_rtb(opt.confidence, 2), ekf.x_est(1:2), 'g', 'Tag', 'ellipse');
%                     for i=1:numcols(ekf.landmarks)
%                         n = ekf.landmarks(1,i) + 3;
%                         if ~isnan(n)
%                             % this landmark has been observed
%                             
%                             xf = ekf.x_est(n:n+1);
%                             P = ekf.P_est(n:n+1,n:n+1);
%                             plot_ellipse( P * chi2inv_rtb(opt.confidence, 2), xf, 'g', 'Tag', 'ellipse');
%                             plot(xf(1), xf(2), 'k.', 'MarkerSize', 10, 'Tag', 'ellipse')
%                         end
%                     end
%                 end
