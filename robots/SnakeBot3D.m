classdef SnakeBot3D < RobotPrimitive & handle
    ...
    methods
        function obj = SnakeBot3D( nq, m_arr, l_arr )
            ...
            obj.Inertias( 1, : ) = 1/12 * obj.Masses .* obj.LinkLengths.^2;
            obj.Inertias( 2, : ) = 1/12 * obj.Masses .* obj.LinkLengths.^2;
            ...
            obj.gEE   = { @scatter3, obj.H_init( 1, 4, obj.nq + 1 ), obj.H_init( 2, 4, obj.nq + 1 ), 180, ...
                          'o', 'MarkerFaceColor', 'k', ...
                          'MarkerEdgeColor', 'k' };                                    
        end
